  ...
  <section class="reg-hero">
    <header class="reg-top">
      <div class="reg-top-inner">
        <nav class="reg-top-right">
          <RouterLink class="reg-top-link" to="/browse">Browse packages</RouterLink>
    ...
    <div class="reg-inner">
      ...
      <div class="reg-links">
        ...
        <RouterLink class="reg-mini-link" to="/docs">Why Vix Registry?</RouterLink>
        <span class="reg-mini-sep">|</span>
      ...
      <RouterLink class="reg-publish" to="/publish">
