    ...
    <div class="wrap">
      ...
      <div class="hero">
        <div class="hero-left">
          ...
          <div class="cta">
            <a class="btn primary" href="https://docs.vixcpp.com/registry/publish" target="_self" rel="noreferrer">Publish docs</a>
...
vix publish 0.1.0 --notes "Initial release"</code></pre>
      ...
      <div class="footer">
        ...
        <div class="foot-right">
          <RouterLink class="btn primary" to="/browse">Browse</RouterLink>
        </div>
      </div>
    </div>
  </section>
